...
const Nav$3 = /*#__PURE__*/React__namespace.forwardRef((_ref, ref) => {
  let {
      // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
      as: Component = 'div',
      onSelect,
...
Nav$3.displayName = 'Nav';
var BaseNav = Object.assign(Nav$3, {
  Item: NavItem$4
});
...
var Nav = function (_a) {
    var className = _a.className, children = _a.children, rest = __rest(_a, ["className", "children"]);
    return (React.createElement(Nav$2, __assign$1({ navbar: false, variant: "pills", className: "flex-column mb-auto mx-auto text-center main-nav ".concat(className) }, rest), children));
};
...
var NavItem = function (_a) {
    ...
    return (React.createElement(Nav$2.Item, null,
...
var SideNavbar = function (_a) {
    var className = _a.className, children = _a.children, rest = __rest(_a, ["className", "children"]);
    return (React.createElement("div", __assign$1({ className: "d-none d-md-flex flex-column flex-shrink-0 sticky-top sidebar-bg-grey p-3 ".concat(className) }, rest),
...
var HeaderNavbar = function (_a) {
    var children = _a.children;
    return (React.createElement(Nav$2, { className: "ms-auto" },
